...
'PSUBSCRIBE',   'PUBSUB',    'PUNSUBSCRIBE', 'QUIT', 
...
'SCAN',  'SSCAN',     'HSCAN',   'ZSCAN', 'PUBLISH'
);
...
(
  ...
  MEMBER FUNCTION PUBLISH(self IN OUT NOCOPY OREDIS, p_topic VARCHAR2, p_value VARCHAR2) RETURN OREDIS_RESP
...
/* PUB/SUB*/
MEMBER FUNCTION PUBLISH(self IN OUT NOCOPY OREDIS, p_topic VARCHAR2, p_value VARCHAR2) RETURN OREDIS_RESP IS
BEGIN
  RETURN EXEC('PUBLISH ' || p_topic || ' ' || p_value);
END PUBLISH;
